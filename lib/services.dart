...
import 'package:med_sci_library/fonts/controller.dart'; // Ensure this path is correct
...
class ServicesPage extends StatelessWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildResponsiveGrid(context, currentFontSize),
                  ...
                  _buildActionCard(
                    buttons: [
                      ...
                      _linkButton(
                        ...
                        () => _handleLaunch(
                          _links['systematic_reviews_training']!,
                        ),
                        currentFontSize,
                      ),
                    ],
                  ...
                  _buildActionCard(
                    buttons: [
                      _linkButton(
                        "Laptop & Tablets",
                        () => _handleLaunch(
                          _links['device_loans_laptop_tablets']!,
                        ),
                        currentFontSize,
                      ),
                      _linkButton(
  ...
  Widget _linkButton(String label, VoidCallback onPressed, double fontSize) {
    return Padding(
  ...
  Widget _buildResponsiveGrid(BuildContext context, double fontSize) {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: fontSize * 0.7, // Scaled description
